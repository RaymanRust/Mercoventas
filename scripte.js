...
const PRODUCTS = [
  ...
  { id: 404, name: 'Capacitor de marcha 65 mf 450v 370/450v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca073.jpg'], priceBase: 11, price1: 9.53, price2: 8.80, price3: 7.70 },
  { id: 405, name: 'Capacitor de marcha 70 mf 370/450v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca075.jpg'], priceBase: 10, price1: 8.62, price2: 7.94, price3: 6.90 },
  { id: 406, name: 'Capacitor de marcha 80 mf 370/450v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca076.jpg'], priceBase: 10, price1: 8.74, price2: 8.11, price3: 7.16 },
  { id: 407, name: 'Capacitor de marcha 80+5mf 440/450v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca077.jpg'], priceBase: 12, price1: 10.52, price2: 9.79, price3: 8.68 },
  { id: 408, name: 'Capacitor de marcha 90 mf 370/450v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca078.jpg'], priceBase: 12, price1: 10.38, price2: 9.57, price3: 8.35 },
  { id: 409, name: 'Capacitor de marcha 100 mf 370/450v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca079.jpg'], priceBase: 12, price1: 10.60, price2: 9.90, price3: 8.85 },
  { id: 410, name: 'Capacitor Arranque 56-72mf 220V plastico', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca080.jpg'], priceBase: 4.50, price1: 3.86, price2: 3.55, price3: 3.07 },
  { id: 411, name: 'Capacitor de Arranque 88 -106 mf 220v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca083.jpg'], priceBase: 4.50, price1: 3.91, price2: 3.61, price3: 3.17 },
  { id: 412, name: 'Capacitor de Arranque 108-130 mf 220v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca084.jpg'], priceBase: 4.50, price1: 3.93, price2: 3.64, price3: 3.21 },
  { id: 413, name: 'Capacitor de Arranque 124-149 mf 220v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca085.jpg'], priceBase: 5, price1: 4.35, price2: 4.02, price3: 3.54 },
  { id: 414, name: 'Capacitor Arranque 130-156 mf 220V Plastico', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca086.jpg'], priceBase: 5, price1: 4.33, price2: 4.00, price3: 3.49 },
  { id: 415, name: 'Capacitor de Arranque 130-156 mf 330v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca087.jpg'], priceBase: 6, price1: 5.22, price2: 4.83, price3: 4.25 },
  { id: 416, name: 'Capacitor de Arranque 145-175 mf 220v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca088.jpg'], priceBase: 8, price1: 6.75, price2: 6.12, price3: 5.18 },
  { id: 417, name: 'Capacitor de Arranque 145-174 mf 330v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca089.jpg'], priceBase: 8, price1: 7, price2: 6.51, price3: 5.76 },
  { id: 418, name: 'Capacitor de Arranque 161-193 mf 330v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca090.jpg'], priceBase: 8, price1: 7.05, price2: 6.58, price3: 5.87 },
  { id: 419, name: 'Capacitor de Arranque 189-227 mf 330v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca094.jpg'], priceBase: 8, price1: 6.96, price2: 6.44, price3: 5.66 },
  { id: 420, name: 'Capacitor de Arranque 216-259 mf 220v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca095.jpg'], priceBase: 9, price1: 7.57, price2: 6.86, price3: 5.79 },
  { id: 421, name: 'Capacitor de Arranque 216-259 mf 330v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca096.jpg'], priceBase: 9, price1: 8.09, price2: 7.64, price3: 6.96 },
  { id: 422, name: 'Capacitor de Arranque 230-280 mf 220v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca097.jpg'], priceBase: 9, price1: 7.64, price2: 6.96, price3: 5.94 },
  { id: 423, name: 'Capacitor de Arranque 233-280 mf 220v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca098.jpg'], priceBase: 9, price1: 7.62, price2: 6.93, price3: 5.90 },
  { id: 424, name: 'Capacitor de Arranque 243-292 mf 220v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca099.jpg'], priceBase: 9, price1: 7.72, price2: 7.08, price3: 6.13 },
  { id: 425, name: 'Capacitor de Arranque 270-324 mf 220v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca100.jpg'], priceBase: 9, price1: 7.76, price2: 7.14, price3: 6.21 },
  { id: 426, name: 'Capacitor de Arranque 270-324 mf 330v', desc: '', categories: ['refrigeracion'], images: ['img/productos/ca101.jpg'], priceBase: 9, price1: 7.92, price2: 7.37, price3: 6.56 },
